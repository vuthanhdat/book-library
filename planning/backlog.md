...
| M6-15 Bounded Study Reader | READ-002, READ-003, READ-004, READ-006, READ-008, OCR-001, OCR-002, DICT-001, DICT-002, DICT-003 | In Progress | M6-05, M6-08, ADR-016 | PDF and image books render one authorized page at a time with bounded navigation, zoom, fullscreen, PDF text-layer selection, explicit OCR fallback, and adjacent instant dictionary lookup; cross-platform smoke and remaining fit/rotation criteria remain. |
